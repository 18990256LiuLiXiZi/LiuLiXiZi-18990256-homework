...
import com.example.qimodazuoye.bean.UserInfo;
import com.example.qimodazuoye.database.UserDBHelper;
import com.example.qimodazuoye.util.DateUtil;
import com.example.qimodazuoye.util.ViewUtil;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, View.OnFocusChangeListener {
    ...
    private String[] typeArray = {"个人用户", "公司用户","18990256 刘李曦梓"};
